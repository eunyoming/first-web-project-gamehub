...
<body
	...
	<main>
        ...
        <div class="form-group">
            ...
            <div class="information">[게임 허브]는 이용자의 개인정보를 소중히 여기며, 「개인정보 보호법」 및 관련 법령을 준수합니다. 본 개인정보 처리방침은 이용자가 회원가입 및 서비스 이용 시 제공한 개인정보가 어떻게 수집, 이용, 보관, 보호되는지 알려드립니다.

---

## 제1조 (수집하는 개인정보 항목)

운영자는 서비스 제공을 위해 다음과 같은 개인정보를 수집할 수 있습니다.

1. **회원가입 시**
- 필수항목: 이메일 주소, 비밀번호, 닉네임
- 선택항목: 프로필 이미지, 관심 게임 정보
1. **서비스 이용 시 자동 수집 항목**
- 접속 로그(IP 주소, 접속 기기, 브라우저 정보)
- 서비스 이용 기록(게임 플레이 기록, 업적 달성 기록 등)
- 쿠키(Cookie) 및 세션 정보
...
수집한 개인정보는 다음 목적에만 사용됩니다.

1. 회원가입, 로그인 및 본인 확인
2. 서비스 제공 및 이용 기록 관리
3. 게임 업적, 랭킹, 친구 시스템 제공
4. 고객 문의 응답 및 민원 처리
5. 보안, 불법 이용 방지, 서비스 품질 향상
6. (선택 동의 시) 마케팅, 이벤트 및 광고 활용
...
1. 회원 탈퇴 시 즉시 파기합니다.
2. 단, 관계 법령에 따라 다음 항목은 아래 기간 동안 보관할 수 있습니다.
    - 계약 및 청약철회 기록: 5년 (전자상거래법)
    - 결제 및 서비스 이용 기록: 5년 (전자상거래법)
    - 로그 기록: 3개월 (통신비밀보호법)
...
운영자는 안정적인 서비스 제공을 위해 개인정보 처리를 외부 업체에 위탁할 수 있습니다. 이 경우 위탁 업체명, 위탁 업무 범위를 사전에 공지하고 동의를 받습니다.
...
3. 개인정보 열람·정정·삭제는 [마이페이지] 메뉴 또는 고객센터를 통해 가능합니다.

---

## 제7조 (개인정보 보호를 위한 기술적/관리적 대책)

운영자는 개인정보를 안전하게 보호하기 위하여 다음과 같은 조치를 취합니다.
...
1. 서비스는 맞춤형 정보 제공을 위하여 쿠키를 사용할 수 있습니다.
2. 이용자는 웹 브라우저의 설정을 통해 쿠키 저장을 거부할 수 있습니다.
    
    단, 일부 서비스 이용에 제한이 있을 수 있습니다.
...
본 개인정보 처리방침은 법령 변경, 서비스 정책 변경에 따라 개정될 수 있으며, 개정 시에는 [게임 허브 공지사항]을 통해 사전 공지합니다.</div>
